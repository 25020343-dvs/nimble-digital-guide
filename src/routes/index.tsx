        ...
        {exercises.map((p) => (
          ...
          >
            ...
            <div className="mt-5 min-h-[76px]">
              ...
              <h3 className="mt-1 font-[Montserrat,Be_Vietnam_Pro,sans-serif] font-extrabold text-stone-100 text-[17px] leading-[1.3] line-clamp-2 uppercase tracking-[0.04em]">
                {p.shortTitle}
              </h3>
            </div>
            <div className="mt-3">
...
function SectionTitle({ id, eyebrow, title, sub }: { id?: string; eyebrow: string; title: string; sub?: string }) {
  return (
    <div id={id} className="scroll-mt-24 max-w-7xl mx-auto px-6 pt-20 pb-10 text-center">
      ...
      <h2 className="mt-3 font-[Montserrat,Be_Vietnam_Pro,sans-serif] text-4xl md:text-6xl font-extrabold leading-[1.15] text-stone-100 uppercase tracking-[0.04em]">{title}</h2>
