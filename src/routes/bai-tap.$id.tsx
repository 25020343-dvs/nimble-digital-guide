      ...
      <div className="grid lg:grid-cols-[240px_minmax(0,1fr)] gap-6 lg:gap-8 pt-6 pb-10 pr-4 lg:pr-8 relative">
        ...
        <div key={animKey} className="space-y-10 min-w-0 animate-[bounceIn_.7s_cubic-bezier(.34,1.56,.64,1)_both] max-w-5xl px-4 lg:px-0">
          ...
          <div className="pt-4">
            ...
            <h1 className="mt-4 vn-heading text-lg md:text-xl font-bold text-stone-100 uppercase">
              {ex.title}
            </h1>
        ...
        <div className="p-7 rounded-2xl bg-[#0f160c] border border-[#1e3319]">
          <h2 className="vn-heading font-bold text-lime-400 text-sm uppercase">🎯 MỤC TIÊU BÀI HỌC CHI TIẾT</h2>
        ...
        <div className="p-7 rounded-2xl bg-[#0f160c] border border-[#1e3319]">
          <h2 className="vn-heading font-bold text-lime-400 text-sm uppercase">🛠️ TÓM TẮT QUÁ TRÌNH THỰC HIỆN</h2>
        ...
        <div className="p-7 rounded-2xl bg-gradient-to-br from-[#101a0a] to-[#0a0f08] border border-lime-500/30">
          <h2 className="vn-heading font-bold text-sm uppercase bg-gradient-to-r from-lime-300 to-yellow-300 bg-clip-text text-transparent">
        ...
        <div className="p-7 rounded-2xl bg-[#0f160c] border border-[#1e3319]">
          <div className="flex items-baseline justify-between flex-wrap gap-2">
            <h2 className="vn-heading font-bold text-lime-400 text-sm uppercase">📑 TOÀN BỘ TRANG BÀI TẬP</h2>
